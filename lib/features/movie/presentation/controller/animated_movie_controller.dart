...
class AnimatedMovieController extends GetxController {
  final GetListSearchMovieUsecase getListSearchMovieUsecase =
      GetIt.instance<GetListSearchMovieUsecase>();

  var isLoading = false.obs;
  var animatedMovies = <SearchMovieEntity>[].obs;

  @override
  void onInit() {
    super.onInit();
    fetchData(path: 'hoat-hinh', page: 1, limit: 10);
  }
