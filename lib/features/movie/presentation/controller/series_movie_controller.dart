...
class SeriesMovieController extends GetxController {
  final GetListSearchMovieUsecase getListSearchMovieUsecase =
      GetIt.instance<GetListSearchMovieUsecase>();

  var isLoading = false.obs;
  var seriesMovies = <SearchMovieEntity>[].obs;

  @override
  void onInit() {
    super.onInit();
    fetchData(path: 'phim-bo', page: 1, limit: 10);
  }
